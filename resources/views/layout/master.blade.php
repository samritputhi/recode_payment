...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="{{ url('admin/js/jquery.mousewheel.js') }}"></script>
<script src="{{ url('admin/js/raphael.min.js') }}"></script>
<script src="{{ url('admin/js/jquery.mapael.min.js') }}"></script>
<script src="{{ url('admin/js/usa_states.min.js') }}"></script>
<!-- ChartJS -->
